...
export const PATTERN_GUIDE: Record<PatternKey, PatternGuide> = {
  common_trend: {
    ...
    period: "스윙 ~ 중기 (4주 ~ 6개월)",
    note:
      "⚠️ 겹침 이득 미확인. 20일 보유 실측(2025-04~2026-08, 63스캔) 결과 이 목록의 20일 선정력은 " +
      "−0.20%(유니버스 대비), 중앙값 −0.78%로 사실상 0입니다. 같은 기간 Stage 2 단독은 +1.92%였습니다 — " +
      "겹침을 요구하면 오히려 희석됩니다. 겹침 보정 t=−0.20으로 통계적으로는 노이즈와 구별되지 않습니다.\n" +
  ...
  common_all: {
    ...
    note:
      ...
      "⚠️ 화면에 뜨는 점수 상위 20종목만 따로 재면 20일 −0.95%, 중앙값 −1.84%로 " +
      "게이트 통과 전체(+0.02%)보다 나쁩니다. 점수가 높을수록 낫다는 근거가 없습니다.",
  },
  canslim: {
    title: "CAN SLIM",
